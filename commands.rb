...
module Commands
  ...
  #
  # This command is safe to use publicly, but consider using the Login command
  # instead.
  class Initiate < Command
    ...
    #   should be passed into an Authenticate command.  Note that this yield is
    #   indirect and may occur some time after the call.
    #
    # Examples
    #
  ...
  # Public: Completes the full log-in procedure to associate a client with the
  # BAPS server.
  #
  ...
  class Login < Command
    ...
    #   inside a block itself yielded by the dispatch, and thus may occur quite
    #   some time after this call.
