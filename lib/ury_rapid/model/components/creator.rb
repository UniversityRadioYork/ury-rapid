...
module Rapid
  module Model
    module Components
      ...
      #
      # Creator contains several methods for building commonly used
      # components for models.  It does not register those components with a
      # registrar; to do this, wrap the Creator in a CreatorWrapper that calls
      # the registrar as a hook.
      class Creator
        extend Forwardable
