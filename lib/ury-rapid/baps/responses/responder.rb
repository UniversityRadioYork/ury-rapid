require 'ury-rapid/baps/codes'
require 'ury-rapid/service_common/handler_set'

# IMPORTANT: All handlers to be registered with the model tree must be required
# here.
require 'ury-rapid/baps/responses/handlers/playback'
require 'ury-rapid/baps/responses/handlers/playlist'
require 'ury-rapid/baps/responses/handlers/system'
